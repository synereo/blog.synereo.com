...
Synereo and Ethereum have now an end to end spec of a correct fault tolerant architecture that is sharded i.e. scales and allows to control the behavior of how to reach consensus with concern to the blockchain. Economic, security and game theories have been taken into account and fit all within the framework. All can be worked out now. Ed gives a demo of LivelyGig. Gary works now on weWOWwe. HJ thinks about onboarding. Shared infrastructure is in the make and financially supported. Noy joins the visual design team. And we had a long discussion about governance and freedom.
...
x!( Q )		is a process on channel **x** that is going to send something **Q**, that is actually some code that's going to be send.<br>

*x 		since names are the codes of processus you ought to be able to take the code of a process that you receive and that you can turn back into a process (turning code back into a process)<br>
